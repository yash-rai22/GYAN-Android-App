...
public class EditorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        page = com.example.kalyan.timetable.MainActivity.mainActivity.currentPage;
        ...
        com.example.kalyan.timetable.Utility.getResults(subjectCursor);
